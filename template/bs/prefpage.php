...
<div id=main>
	...
	<center><table>
		...
		<select name="sl">
		<option value=<?php echo $sl; ?> selected=true><?php echo $sl; ?> [Now]</option>	
		<?php 
		
		$sql="SELECT `name`,`id` FROM templates WHERE 1";
...
?>
		...
		<tr><td>IDEONE_UserID:
			<td><input name="uid2" size=50 type=text value="<?php echo $uid2; ?>" >
		</tr>
		<tr><td>IDEONE_Password:
			<td><input name="pwd2" size=20 type=password value="<?php echo $pwd2; ?>">
		</tr>
		<tr><td>Custom HTML:
