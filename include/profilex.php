...
header("Pragma: no-cache");
	...
	$profile="";
		if (isset($_SESSION['user_id'])){
				...
				$profile.= "<li><a href=./modifypage.php><i class='icon-user icon-white'></i> &#20462;&#25913;&#29992;&#25143;&#36164;&#26009;</a></li><li><a href='./userinfo.php?user=$sid'><i class='icon-user icon-white'></i> <span id=red>$sid</span></a></li>";
				$mail=checkmail();
				if ($mail)
