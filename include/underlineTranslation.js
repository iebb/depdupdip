...
function _dictUpdateStatus(){
  ...
  if(d){
    if (_dict_enable){
       _dictSet(d,'<a href="javascript:dictDisable()" title="&#25105;&#35201;&#31105;&#29992;&#21010;&#35789;&#32763;&#35793;">Disable Translation</a>');
    }else{
	   _dictSet(d,'<a href="javascript:dictEnable()" title="&#25105;&#35201;&#24320;&#21551;&#21010;&#35789;&#32763;&#35793;">Enable Translation</a>');
    }
  }
...
function _dictStatus(){
    ...
    var h='<a href="'+_dict_help+'" title="&#25105;&#35201;&#26597;&#30475;&#21010;&#35789;&#24110;&#21161;" target="_blank" style="color:#1A9100;'+b+'">&#21010;&#35789;&#32763;&#35793;</a>&#30050;';
    if (_dict_enable){
      h += '<a href="javascript:dictDisable()" title="Disable Translation" target="_self" style="color:#1A9100;'+b+'">Disable Translation</a>';
    }else{
      h += '<a href="javascript:dictEnable()" title="Enable Translation" target="_self" style="color:#1A9100;'+b+'">Enable Translation</a>';
    }
