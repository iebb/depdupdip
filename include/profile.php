...
header("Pragma: no-cache");
	...
	$profile="";
		if (isset($_SESSION['user_id'])){
				...
				$profile.= "<div class='sep'></div> <p /><li><a href=./modifypage><i class='icon-pencil icon-white'></i> &#20462;&#25913;&#29992;&#25143;&#36164;&#26009;</a></li><li><a href=./preferences><i class='icon-pencil icon-white'></i> 偏好设置</a></li><li><a href='./userinfo?user=$sid'><i class='icon-user icon-white'></i> <span id=red>$sid</span></a></li>";
				$mail=checkmail();
				if ($mail)
