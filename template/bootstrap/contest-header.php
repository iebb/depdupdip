...
<link href="http://wetta.in/template/classic/style.css" rel="stylesheet" type="text/css" />
...
if (!isset($_SESSION['user_id'])) echo '
	...
	<div><a href="./login_qq.php"><img src="./qq_login.gif" /></a>
		<a href="./login_weibo.php"><img src="./loginbtn_03.png" /></a>
		<a href="./login_renren.php"><img src="./loginrr.png" /></a>	
	</div>
	  </div>
...
function newPopup(url) {
  ...
  <li class="nav-header">
    ...
    <li>
        <a href="contest?cid=<?php echo $cid?>">
    ...
    <li>
        <a href="contestrank?cid=<?php echo $cid?>">
            <i class="icon-fire icon-white"></i>
            比赛排名
        </a>
    </li>
    <li>
        <a href="conteststatistics?cid=<?php echo $cid?>">
...
<div class="copyright">
	...
	Based On <a href="http://code.google.com/p/hustoj/">HUSTOJ</a>
	<!--[if lt IE 10]><![endif]-->
...
<div class="navbar navbar-inverse" style="position: static;">
                ...
                <div class="container">
                  ...
                  <div class="nav-collapse subnav-collapse">
                    <ul class="nav">
                      ...
                      <li><a href="problemset.php?page=1">ProblemSet</a></li>
                      <li><a href="ranklist.php">Ranking</a></li>
                      <li class="dropdown">
					  ...
					  <script type="text/javascript">dictInit();</script></li>
                          ...
                          <li><a href="modifypage.php">Profile</a></li>
                          <li><a href="preferences.php">Preferences</a></li>
                        </ul>
                      </li>
                    </ul>
                    <form class="navbar-search pull-left" action="problemset.php">
                      <input type="text" action="problemset.php" name="search" class="search-query span2" id="Searchbar" placeholder="Search">
                    </form>
  ...
  <ul class="dropdown-menu">
    <li><a href="modifypage.php"><i class="icon-pencil"></i> Edit</a></li>
    <li><a href="mail.php"><i class="icon-envelope"></i> Inbox</a></li>
    <li><a href="status.php?user_id=jebwizoscar"><i class="icon-info-sign"></i> Status</a></li>
    <li class="divider"></li>
