...
<a href="inbox" rel="INBOX">收件箱<span class="unreadcount"><?php echo checkmail(); ?></span></a>
</li>
<li class="mailbox inbox unread selected">
<a href="new" rel="INBOX">新邮件</a>
</li>
<li class="mailbox inbox unread selected">
<a href="status" rel="INBOX">状态</a>
</li>
<li class="mailbox inbox unread selected">
<a href="problemset" rel="INBOX">问题</a>
</li>
</ul>
...
<tbody>
	<tr>
		...
		<td class="editfield"><textarea name="to_user" spellcheck="false" cols="30" rows="1" tabindex="2"></textarea></td>
	</tr><tr>
...
<div id="composeview-bottom">
		<textarea name="content" id="composebody" cols="100%" rows="100%" maxlength="2000" ></textarea>
</div>
