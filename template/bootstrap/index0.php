    ...
    <div class="span4">
        ...
        <div class="cell">
            ...
            <div class="body content">
                <ul class="tagcloud">
                    <form action="problemset.php" class="form-search" method="get">
					...
					<form action="problem.php" class="form-search" method="get">
					<div class="input-prepend">
					<button type="submit" class="btn">P-ID</button>
					<input type="text" class="span2 search-query" id="id">
